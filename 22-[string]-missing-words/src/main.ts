import * as missingWords from "./missingWords.ts";

document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  <div>
   <h2>Missing Words</h2>
   <p style='color:red; font-weight:bold'>Asked in IBM</h2>


<pre style='background:black; padding:1rem'><code style='color:orange; font-size:1rem'>
